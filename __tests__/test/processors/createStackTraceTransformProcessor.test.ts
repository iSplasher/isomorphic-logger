import { createStackTraceTransformProcessor } from "../../../src/processors/createStackTraceTransformProcessor";
...
describe(`createStackTraceTransformProcessor`, () => {
  it(`invokes transformer function if a message is an instance of Error class`, () => {
    ...
    const stackTraceExtractor = createStackTraceTransformProcessor({
      transformer,
    });
